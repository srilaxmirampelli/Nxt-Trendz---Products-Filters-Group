...
class AllProductsSection extends Component {
  ...
  updateSearchInput = titleSearch => {
    this.setState({searchInput: titleSearch})
  }
  ...
  onClickCategory = newCategoryId => {
    this.setState({activeCategoryId: newCategoryId}, this.getProducts)
  }

  onClickRating = newRatingId => {
    this.setState({activeRatingId: newRatingId}, this.getProducts)
  }
